...
function IndexedLinkedList(){this.list={},this.length=0,this.head=null,this.tail=null}IndexedLinkedList.prototype.peek=function(){if(this.length>0)return this.head.data;throw new Error("list_empty")},IndexedLinkedList.prototype.hasIndex=function(t){return"object"==typeof this.list[t]},IndexedLinkedList.prototype.forEach=function(t){for(var e=this.head;null!=e;)t(e.data),e=e.next},IndexedLinkedList.prototype.dequeue=function(){return this._removeItem(this.head)},IndexedLinkedList.prototype.remove=function(t){this._removeItem(this.list[t])},IndexedLinkedList.prototype.push=function(t,e){var i=this._resetIndex(t,e);null!=this.head&&(this.head.prev=i),i.prev=null,i.next=this.head,this.head=i,0==this.length&&(this.tail=i),this.length++},IndexedLinkedList.prototype.enqueue=function(t,e){var i=this._resetIndex(t,e);null!=this.tail&&(this.tail.next=i),i.next=null,i.prev=this.tail,this.tail=i,0==this.length&&(this.head=i),this.length++},IndexedLinkedList.prototype._resetIndex=function(t,e){try{this.remove(t)}catch(t){}return this._set(t,e)},IndexedLinkedList.prototype._set=function(t,e){return"object"==typeof this.list[t]?this.list[t].data=e:this.list[t]={data:e,next:void 0,prev:void 0},this.list[t]},IndexedLinkedList.prototype._removeItem=function(t){if("object"!=typeof t||null==t)throw new Error("undefined_item");return null==t.next?this.tail=t.prev:t.next.prev=t.prev,null==t.prev?this.head=t.next:t.prev.next=t.next,this.length--,t.data},module.exports=function(){return new IndexedLinkedList};
},{}],2:[function(require,module,exports){
function JobsQueue(t){var e={maxSimultaneous:1};this.options=this._objectMerge(e,t),this.queuedJobList=IndexedLinkedList(),this.inprogressJobList=IndexedLinkedList(),this.inprogress=0,this.queued=0}var IndexedLinkedList=require("./IndexedLinkedList");JobsQueue.prototype._tryStartNextJob=function(){function t(t){var o=t.filter(function(t){return e(t)>0});return o.length>0?Math.min.apply(null,o):0}function e(t){return"number"==typeof t&&t>0?t:0}if(this.queuedJobList.length){var o=e(this.options.maxSimultaneous),i=0;this.inprogressJobList.forEach(function(e){i=t([i,e.options.maxSimultaneous])});var n=this.queuedJobList.peek(),r=e(n.options.maxSimultaneous),s=t([o,i,r]);if(s<=0||this.inprogress<s){var u=this.queuedJobList.dequeue();this.queued--,this.inprogressJobList.enqueue(u.jobId,u),this.inprogress++,u.start(u.controller.complete),this._tryStartNextJob()}}},JobsQueue.prototype._finishJob=function(t){if(this.inprogressJobList.hasIndex(t))this.inprogressJobList.remove(t),this.inprogress--,this._tryStartNextJob();else{if(!this.queuedJobList.hasIndex(t))throw new Error("job_not_found");this.queuedJobList.remove(t),this.queued--,this._tryStartNextJob()}},JobsQueue.prototype.enqueue=function(t,e){var o=this,i=this._uniqueId(),n={cancel:function(){o._finishJob(i)},complete:function(){o._finishJob(i)}};return o.queuedJobList.enqueue(i,{jobId:i,start:t,options:o._objectMerge({},e),controller:n}),this.queued++,this._tryStartNextJob(),n},JobsQueue.prototype._objectForEach=function(t,e){var o;for(o in t)t.hasOwnProperty(o)&&e(t[o],o,t)},JobsQueue.prototype._objectMerge=function(){var t={};return this._objectForEach(arguments,function(e){for(var o in e)e.hasOwnProperty(o)&&(t[o]=e[o])}),t},JobsQueue.prototype._uniqueId=function(){function t(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return t()+t()+"-"+t()+"-"+t()+"-"+t()+"-"+t()+t()+t()},module.exports=function(t){return new JobsQueue(t)};
